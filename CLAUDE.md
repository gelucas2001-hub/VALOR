...
|---|---|---|
| `actualizar.py` | Baja datos de ESPN y calcula λ. Corre solo, 2 veces por día, vía GitHub Actions. **Seis competiciones desde el 2026-09-02**: entró `jpn.1` y **volvió `arg.copa`** — se agregó `jpn.1`, que era la única de las seis medidas con el mejor punto estimado de ROI (+2.78% ±7.67) y no estaba en la app. México se midió el mismo día y NO entra (−3.46% ±7.50). Ver TRASPASO §24 | Con cuidado — es el motor |
