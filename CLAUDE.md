...
| `probar_odds_api.py` | Si conviene cambiar DraftKings —la única casa que expone ESPN— por Pinnacle. Prueba de The Odds API. Necesita `ODDS_API_KEY` | A mano |
