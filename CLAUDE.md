...
|---|---|---|
| `actualizar.py` | Baja datos de ESPN y calcula λ. Corre solo, 2 veces por día, vía GitHub Actions. **Once competiciones**: `arg.1`, `bra.1`, `eng.1`, `fra.1`, `esp.1`, `ger.1`, `ita.1`, `arg.copa`, `conmebol.libertadores`, `conmebol.sudamericana`, `uefa.champions`. **`jpn.1` entró y salió el mismo día (2026-09-02)**: entró por tener el mejor punto estimado de ROI de las seis medidas y salió porque Bet365 no la cotiza. La reemplazó **`esp.1`**, y luego el 2026-09-08 entraron **`ger.1`**, **`ita.1`** y **`uefa.champions`** con anclaje doméstico verificado y cobertura de Bet365 probada. Ver TRASPASO §24 y el bloque de COMPETICIONES en el propio archivo, que es la fuente de verdad | Con cuidado — es el motor |
